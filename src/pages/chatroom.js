                ...
                <div className="container mx-auto bg-gray-200">
                    <div className="h-screen">
                        <div className="flex border border-grey rounded shadow-lg h-full">
                            <div className="w-1/4 border rounded-3xl flex flex-col my-4 ml-4 bg-white">
                                <div className="py-4 px-4 bg-grey-lightest">
                                    <input type="text" className="w-full border rounded-3xl px-2 py-2 text-sm" placeholder="Search or start new chat"/>
                                </div>
                            ...
                            <div className="w-3/4 border rounded-3xl flex flex-col my-4 mx-4 bg-white">
                        ...
                        <p className="text-xs">
                          Messages to this chat and calls are now secured with end-to-end encryption. Tap for more info.
                                        ...
                                        <div className="flex mb-2">
                                            <div className="rounded py-2 px-3 bg-blue-300">
